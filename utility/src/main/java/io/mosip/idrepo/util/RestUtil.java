...
import io.mosip.idrepo.dto.Metadata;
import io.mosip.idrepo.dto.SecretKeyRequest;
import io.mosip.idrepo.dto.TokenRequestDTO;
...
public class RestUtil {
	...
	private SecretKeyRequest setSecretKeyRequestDTO() {
		...
		request.setAppId(environment.getProperty("mosip.idrepo.auth.appId"));
		request.setClientId(environment.getProperty("mosip.idrepo.auth.clientId"));
		request.setSecretKey(environment.getProperty("mosip.idrepo.auth.secretKey"));
		return request;
	}
}
